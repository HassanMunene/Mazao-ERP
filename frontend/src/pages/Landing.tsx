...
import { ArrowRight, Shield, Users, BarChart3, Leaf, Menu, X } from 'lucide-react';
                            ...
                            <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white p-3 rounded-t-xl flex items-center space-x-2">
                                ...
                                <div className="flex-1 mx-3">
                                    <div className="bg-green-700/50 backdrop-blur-sm text-green-100 text-xs py-1 px-3 rounded-full text-center truncate">
                                        dashboard.mazao-erp.com
                                    </div>
                                </div>
                                <div className="text-green-200 text-sm">✓ Live</div>
                            </div>
                                ...
                                <div className="relative h-full flex">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center justify-between mb-4 p-2">
                                            <div>
                                                <div className="text-green-900 font-semibold text-sm">Farm Overview</div>
                                                <div className="text-green-600 text-xs">Updated just now</div>
                                            </div>
